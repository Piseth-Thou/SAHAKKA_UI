...
function PostProjectDetail() {
    ...
    console.log("projectPost by ID : ", projectPost[0])
        ...
        <>
            {
                !isLoading ?
                    <div className="post-detail bs-card-detail">
                        <Container>
                            {
                                projectPost.map((value) => {
                                    const descriptions = value.description.split('\n')
                                    // console.log("dedjshfjsa",descriptions);
                                    return (
                                        <>
                                            ...
                                            <Row className="my-5 revers">
                                                            ...
                                                            <div className="posted-by mt-4">
                                                                <div className="d-flex mb-2">
                                                                    ...
                                                                    <h6 className="mt-3 ms-1">
                                                                        ...
                                                                        <a onClick={() => history.push('/profile_detail/' + value.user.user_id)} style={{ fontSize: '12px', fontWeight: '400', color: '#ffb000', textDecoration: 'none' }}>
                                                ...
                                                <Col xl={9} lg={8} md={12} sm={12} xs={12}>
                                                    <div className="des mt-5">
                                                        ...
                                                        {value.description === "" ? "No descrition show" : 
